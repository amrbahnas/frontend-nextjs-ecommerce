...
const CustomizeProducts = ({
  ...
  useEffect(() => {
    const variant = variants.find((v: any) => {
      const variantChoices: { [key: string]: string } = v.choices; // Add index signature to variantChoices
  ...
  const isVariantInStock = (choices: { [key: string]: string }) => {
    return variants.some((variant: any) => {
      const variantChoices: { [key: string]: string } = variant.choices; // Add index signature to variantChoices
      if (!variantChoices) return false;
