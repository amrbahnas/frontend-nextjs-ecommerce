...
const VerifyEmail = () => {
  ...
  const getTitleAndButtonText = useCallback(
    (screen: SCREENS) => {
      switch (screen) {
        case SCREENS.EMAIL_VERIFIED:
          return { formTitle: t("title"), buttonTitle: t("button.verify") };
        case SCREENS.SEND_Email_CODE:
          return {
            formTitle: t("title"),
            buttonTitle: t("button.verifyEmail"),
          };
        case SCREENS.VERIFICATION_Email_CODE:
          return {
            formTitle: t("title"),
            buttonTitle: t("button.continue"),
          };
        default:
          ...
          <Spin spinning={loading}>
            ...
            {screen === SCREENS.SEND_Email_CODE && (
              <div className="flex flex-col gap-2 w-full md:w-[500px] mb-4 ">
                ...
                <div className=" text-center">
                  <span className="mt-2 text-sm">{t("oneStepAway")}</span>
            ...
            {screen === SCREENS.VERIFICATION_Email_CODE && (
              <div className="flex flex-col gap-4  justify-center items-center">
                ...
                <div className="text-lg flex flex-col items-center">
                  ...
                  <span className="  font-semibold ps-1">{user?.email}</span>
                </div>
            ...
            >
              <Button
                ...
                size="large"
              >
                {loading ? t("button.loading") : buttonTitle}
              </Button>
            </div>
          </Spin>
        </Form>
