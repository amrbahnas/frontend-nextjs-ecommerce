...
const SignUpPage = () => {
  ...
  return (
    <Container className="h-[calc(100dvh-80px)] flex items-center justify-center">
      <div className=" w-full md:w-7/12    p-4 md:p-8 !pt-0 rounded-md shadow-md mt-3 dark:bg-dark-bg border border-gray-200 dark:border-dark-border dark:shadow-dark-bg-secondary">
